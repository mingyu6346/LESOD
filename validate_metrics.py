...
if __name__ == "__main__":
    mask_root = "./dataset/TestDataset/NLPR/GT"
    pred_root = "./test_maps/Base/NLPR"
    ...
    print(f"max_performance: {max_performance:.3f} / 4.000")
    print(f"avg_performance: {avg_performance:.3f} / 4.000")
    print(x_dict)
